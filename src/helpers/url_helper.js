export const GET_NLU_DATA = '/nlu_data';
...
//EXAMPLES
export const GET_EXAMPLES = '/nlu_data/example/';
export const GET_EXAMPLE_DETAIL = '/nlu_data/example/';
export const GET_NLU_DATA_INFO = '/nlu_data/info/';
